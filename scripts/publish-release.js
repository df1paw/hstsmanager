...
const files = [
	path.join(__dirname, '..', 'archives', `hstsmanager-v${package.version}.tar.gz`),
	path.join(__dirname, '..', 'archives', `hstsmanager-v${package.version}.tar.gz.asc`),
	path.join(__dirname, '..', 'archives', `hstsmanager-v${package.version}.tar.gz.ncsig`),
	path.join(__dirname, '..', 'archives', `hstsmanager-v${package.version}.tar.gz.sig`),
];
